...
Содержит классы параметров для одноканальных СМО без учета ухода заявок, с фиксированной
интенсивностью ухода, а также для перебора интенсивности ухода (ν).
"""
