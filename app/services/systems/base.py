...
class BaseServerSystem(ABC):
    ...
    Задает интерфейс и общую структуру для всех моделей СМО, включая параметры системы и
    конфигурацию вычислений. Является основой для всех специализированных реализаций СМО
    (одноканальные, многоканальные, MAP-потоки и др.) и их расчётов.
    """
