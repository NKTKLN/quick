...
class SystemType(Enum):
    ...
    Attributes:
        ...
        MAP: СМО с Марковским входным потоком.
        MULTI_MAP: СМО с Марковскими входными потоками и несколькими датчиками.
    """

    MULTI = "Многолинейная"
    """Многоканальная система массового обслуживания."""

    MAP = "С Марковскими входными потоками"
    """Система массового обслуживания с Марковскими входными потоками."""

    MULTI_SENSOR_MAP = "С Марковскими входными потоками и несколькими датчиками"
