...
from quick.domain.models import BaseSystemParams
...
class BaseMAPMatrixBuilder(BaseMatrixBuilder):
    """Базовый класс построителя матриц коэффициентов для СМО с Марковскими входными потоками.

    Определяет интерфейс построения квадратной матрицы коэффициентов для систем
    дифференциальных уравнений, описывающих поведение СМО сМарковскими входными потоками.
    """
